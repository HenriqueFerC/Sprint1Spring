...
public record DetalhesPagamentoDto(Long id, Long numeroCartao, int senhaCartao, LocalDate dataValidade, String nome, double preco, DetalhesUsuarioDto usuarioDto) {
