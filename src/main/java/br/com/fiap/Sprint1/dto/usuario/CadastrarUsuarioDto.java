...
public record CadastrarUsuarioDto(@NotEmpty(message = "Campo não pode ser vazio!")
                                  ...
                                  String senha,
                                  @NotEmpty(message = "Campo não pode ser vazio!")
                                  @Size(min = 14, max = 14, message = "Campo precisa de no mínimo e no máximo 14 caracteres!")
                                  String cpf,
                                  @NotEmpty(message = "Campo não pode ser vazio!")
